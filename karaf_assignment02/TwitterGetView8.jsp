...
<html>
<head>
    <title>Twitter Interface API 8 - Returns a collection of numeric IDs for every protected user for whom the authenticating user has a pending follow request.</title>
    <h2>https://api.twitter.com/1.1/friendships/outgoing.json</h2>
</head>
<body>
    <table>
        ...
        <%
            String cursor = request.getParameter("rest8cursor");
            String stringify_ids = request.getParameter("rest8q1");
            ...
            String fullURL = "https://api.twitter.com/1.1/friendships/outgoing.json"+params.toString();
