...
<html>
<head>
    <title>Twitter Interface API 7 - Returns a collection of numeric IDs for every user who has a pending request to follow the authenticating user.</title>
    <h2>https://api.twitter.com/1.1/friendships/incoming.json</h2>
</head>
<body>
    <table>
        ...
        <%
            String cursor = request.getParameter("rest7cursor");
            String stringify_ids = request.getParameter("rest7q1");
            ...
            String fullURL = "https://api.twitter.com/1.1/friendships/incoming.json"+params.toString();
